      ...
      return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-8 text-center">
          <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-2xl border border-red-100">
            ...
            <h1 className="text-2xl font-black text-slate-900 mb-4 font-display">Waduh! Terjadi Kesalahan</h1>
            ...
            <button
              ...
              className="w-full py-4 bg-indigo-600 text-white rounded-xl font-bold uppercase tracking-widest hover:bg-indigo-700 transition-all font-display"
            >
              Muat Ulang Halaman
            </button>
          </div>
